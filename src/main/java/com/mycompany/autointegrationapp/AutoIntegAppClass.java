...
public class AutoIntegAppClass {
    ...
    public static void main(String[] args) {
        ...
        //E:\Users\Lennoximus\Documents\NetBeansProjects\AutoIntegrationApp
        
        AutoIntegAppClass ex = new AutoIntegAppClass();
        
        System.out.println("Welcome to the Automatic Database Integration App.\n Proceed typing commands. Use '?' for any help needed.");
        
        // Недоделанная реализация команд для удобства использования.
        ...
        switch(selectedOption) {
            case "?":
                System.out.println("open 'name_of_the_file' - reads settings file. It should be located "
                        + "in the root dir.");
                break;
            case "ope":

            default:
                System.out.println("Unknown command line. Try using '?' for any help needed.");
                break;
        }*/
        
        // Вводим любое служебное слово (в идеале сделать 'open') и название xls-файла
        String[] test = in.nextLine().split("\\s+");
        ex.setSettingsNameFile(test[1]);
        try {
            FileInputStream fileInputStream = new FileInputStream(ex.getSettingsNameFile());
            System.out.println("File '" + ex.getSettingsNameFile() + "' has been opened successfully.");
